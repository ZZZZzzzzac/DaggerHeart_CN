...
| 魔杖     | 知识   | 远距离 | d6+1   | 单手   |                                                                      |
| 巨杖     | 知识   | 极远   | d6     | 双手   | 强力: 额外骰1个伤害骰并去掉其中最小的一个                            |
...
| 鎏金弯刀   | 力量   | 近战   | d10+4  | 单手   | 强力: 额外骰1个伤害骰并去掉其中最小的一个                               |
| 拳刃       | 力量   | 近战   | d10+6  | 双手   | 残暴: 伤害骰每掷出一次最大值，就额外掷出一个伤害骰                      |
| 乌洛克阔剑 | 灵巧   | 近战   | d8+3   | 单手   | 致命: 造成严重伤害时，额外造成 1 生命点                                 |
...
| 巨弓       | 力量   | 远距离 | d6+6   | 双手   | 强力: 额外骰1个伤害骰并去掉其中最小的一个                               |
...
| 改良魔杖       | 知识   | 远距离 | d6+4   | 单手   |                                                                                                  |
| 改良巨杖       | 知识   | 极远   | d6+3   | 双手   | 强力: 额外骰1个伤害骰并去掉其中最小的一个                                                        |
...
| 长者之弓       | 本能   | 远距离 | d6+4   | 双手   | 强力: 额外骰1个伤害骰并去掉其中最小的一个                                                        |
...
| 勇气之剑   | 力量   | 近战   | d12+7  | 双手   | 勇气: 闪避值 -1 ，重伤阈值 +3                                             |
...
| 双连枷     | 敏捷   | 邻近   | d10+8  | 双手   | 强力: 额外骰1个伤害骰并去掉其中最小的一个                                 |
...
| 高级魔杖         | 知识   | 远距离 | d6+7   | 单手   |                                                                         |
| 高级巨杖         | 知识   | 极远   | d6+6   | 双手   | 强力: 额外骰1个伤害骰并去掉其中最小的一个                               |
...
| 毁灭符文         | 知识   | 邻近   | d20+4  | 单手   | 苦痛Painful: 每次你使用此武器成功攻击时，你需**标记 1 压力点**          |
| 维多加斯特的吊坠 | 知识   | 近距离 | d10+5  | 单手   | 时间扭曲者Timebender: 你可以在攻击掷骰后选择攻击目标                    |
| 鎏金弓           | 灵巧   | 远距离 | d6+7   | 双手   | 自省: 伤害掷骰中的所有1都视为6                                          |
| 火焰杖           | 本能   | 远距离 | d6+7   | 双手   | 灼烧: 伤害掷骰中骰出的每个6都对目标**标记 1 压力点**                    |
| 法师球           | 知识   | 远距离 | d6+7   | 单手   | 强力: 额外骰1个伤害骰并去掉其中最小的一个                               |
...
| 传奇巨杖     | 知识   | 极远   | d6+9   | 双手   | 强力: 额外骰1个伤害骰并去掉其中最小的一个                                    |
...
| 漂浮碎刃     | 本能   | 近距离 | d8+9   | 单手   | 强力: 额外骰1个伤害骰并去掉其中最小的一个                                    |
...
| 高级塔盾   | 力量   | 近战   | d6+4   | 副手   | 壁垒r: 护甲值+4，闪避值-1                                                               |
...
| 传奇塔盾   | 力量   | 近战   | d6+6   | 副手   | 壁垒r: 护甲值+5，闪避值-1                                                                  |
...
| 传奇手弩   | 灵巧   | 远距离 | d6+7   | 副手   |                                                                                            |
| 勇气之盾   | 敏捷   | 近战   | d4+6   | 副手   | 庇护：当你标记一个护甲槽时，它将为你和所有近战范围内受到同源伤害的盟友减免伤害。           |
| 拳爪       | 力量   | 近战   | d6+8   | 副手   | 双击: 当你使用主要武器进行一次攻击后，你可以同时使用此武器对另一名近战范围内的敌人造成伤害 |
| 引物碎片   | 本能   | 邻近   | d4     | 副手   | 锁定: 使用此武器对成功攻击一名敌人后，你的主武器对其的下一次攻击将自动命中                 |


##### Table armor_t1
| <div style="width:100px">名称</div> | <div style="width:40px">护甲值</div> | <div style="width:100px">阈值</div> | 特性 |
|:---------|---------:|:------------|:-----------------------|
| 填充布甲 |        3 | ['5', '11'] | 灵活: 闪避值+1         |
| 皮甲     |        3 | ['6', '13'] |                        |
| 链甲     |        4 | ['7', '15'] | 重型: 闪避值-1         |
| 全板甲   |        4 | ['8', '17'] | 极重: 闪避值-2，敏捷-1 |


##### Table armor_t2
| <div style="width:100px">名称</div> | <div style="width:40px">护甲值</div> | <div style="width:100px">阈值</div> | 特性 |
|:---------------|---------:|:-------------|:---------------------------------------------------------------------------------------------|
| 改良填充布甲   |        4 | ['7', '16']  | 灵活: 闪避值+1                                                                               |
| 改良皮甲       |        4 | ['9', '20']  |                                                                                              |
| 改良链甲       |        5 | ['11', '24'] | 重型: 闪避值-1                                                                               |
| 改良全板甲     |        5 | ['13', '28'] | 极重: 闪避值-2，敏捷-1                                                                       |
| 埃伦德里安链甲 |        4 | ['9', '21']  | 防护：受魔法伤害时，在计算伤害阈值前按护甲值减免伤害。                                       |
| 掠骸护甲       |        4 | ['9', '21']  | 坚韧：在标记最后一个护甲槽之前，掷一个 d6。如果掷出6，则可以降低伤害一个等级而无需标记槽位。 |
| 铁木胸甲       |        4 | ['9', '20']  | 强化：当你标记最后一个护甲槽时，你的伤害阈值提升+2，直至你清除至少1个护甲槽。                |
| 符文浮甲       |        4 | ['9', '20']  | 转移：当你成为攻击目标时，可以**标记 1 护甲槽*，使针对你的攻击检定具有劣势                   |
| 泰瑞斯软甲     |        5 | ['8', '18']  | 安静: 任何试图不被人听到的移动动作掷骰 +2                                                    |
| 蔷薇野甲       |        5 | ['11', '23'] | 希冀: 每当你需要**花费希望点**时，你可以改为**标记护甲槽**                                   |


##### Table armor_t3
| <div style="width:100px">名称</div> | <div style="width:40px">护甲值</div> | <div style="width:100px">阈值</div> | 特性 |
|:-----------------|---------:|:-------------|:----------------------------------------------------------------------------|
| 高级填充布甲     |        5 | ['9', '23']  | 灵活: 闪避值+1                                                              |
| 高级皮甲         |        5 | ['11', '27'] |                                                                             |
| 高级链甲         |        6 | ['13', '31'] | 重型: 闪避值-1                                                              |
| 高级全板甲       |        6 | ['15', '35'] | 极重: 闪避值-2，敏捷-1                                                      |
| 贝拉莫伊精致护甲 |        5 | ['11', '27'] | 鎏金: 风度+1                                                                |
| 龙鳞护甲         |        5 | ['11', '27'] | 坚不可摧: 每短休一次，当你的生命值即将归零时，你可以改为**标记 1 压力点**。 |
| 尖刺护甲         |        5 | ['10', '25'] | 锋利: 每当你成功进行近战攻击时，伤害骰加1d4                                 |
| 剑刃护甲         |        6 | ['16', '39'] | 物理防御: 你不能使用此护甲抵消魔法伤害                                      |
| 莫奈特的斗篷     |        6 | ['16', '39'] | 魔法防御: 你不能使用此护甲抵消物理伤害                                      |
| 强化符文         |        6 | ['17', '43'] | 苦痛: 每当你因受到攻击而标记1点或更多的护甲槽时，你需**标记 1 压力点**      |


##### Table armor_t4
| <div style="width:100px">名称</div> | <div style="width:40px">护甲值</div> | <div style="width:100px">阈值</div> | 特性 |
|:---------------|---------:|:-------------|:---------------------------------------------------------------------------------|
| 传奇填充布甲   |        6 | ['11', '32'] | 灵活: 闪避值+1                                                                   |
| 传奇皮甲       |        6 | ['13', '36'] |                                                                                  |
| 传奇链甲       |        7 | ['15', '40'] | 重型: 闪避值-1                                                                   |
| 传奇全板甲     |        7 | ['17', '44'] | 极重: 闪避值-2，敏捷-1                                                           |
| 威能丝甲       |        7 | ['13', '36'] | 时缓：标记一个护甲槽，投掷一枚d4骰子，并将结果作为闪避加值应用于对抗此次来袭攻击 |
| 引导护甲       |        5 | ['13', '36'] | 引导: 当装备此护甲时，所有施法掷骰+1                                             |
| 织烬护甲       |        6 | ['13', '36'] | 燃烧: 每当有敌人在近战范围内击中你时，他们立即**标记 1 压力点**                  |
| 全面强化护甲   |        4 | ['15', '40'] | 坚毅：当你标记一个护甲槽时，可将攻击的严重程度降低两级而非一级                   |
| 诚实蛋白石护甲 |        6 | ['13', '36'] | 求真: 当任何人在近距离范围内说谎时，此护甲将会发光                               |
| 救世主链甲     |        8 | ['18', '48'] | 困难: 所有角色属性以及闪避值-1                                                   |
